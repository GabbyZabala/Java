...
public class Act2_Zabala_Modified{
	public static void main(String[] args) {
		...
		for(int i = 0; i<Details.length;i++){
			...
			switch(i){
				case 1:
					if(console<1 || console>12)trap = true;
					else  input[i]= console;
					break;
				case 2:
					if(console<1 || console>31)trap = true;
					else input[i] = console;
					break;
				default:
					input[i] = console;
		...
		String Dayish;
		int day = input[2];
		if(day == 1 || day == 11|| day == 21 || day == 31)Dayish = "st";
		else if(day == 2 || day == 12||day == 22)Dayish = "nd";
		else if(day == 3 || day == 13 ||day == 23)Dayish = "rd";
		else Dayish = "th";
		if(!trap){
